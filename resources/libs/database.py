from robot.api.deco import keyword  #consegue constomisar o nome do metodo
from pymongo import MongoClient
import  bcrypt


client = MongoClient('mongodb+srv://qa:xperience@cluster0.id4wv7f.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0')
...
#@keyword('Insert user from database')  >> Primeira versão
